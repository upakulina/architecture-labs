...
![Диаграмма системного контекста](./system_context_diagram_1.png)
...
![Диаграмма компонентов Backend API](./component_diagram_1.png)
...
![Диаграмма компонентов Web UI](./webUI-component_diagram.png)
